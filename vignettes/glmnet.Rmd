...
=================================
First, we must generate a set of penalised regression models. To do this, we
may use example data from the `glmnet` package. In order to visualise the 
...
It is worth noting that this is a very useful visualisation. In LASSO
models, one may observe how many coeffients drop off at different values
...
it is useful to disable clustering. In this instance, we will retain row clustering
